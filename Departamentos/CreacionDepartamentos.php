    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <di id="collapseDepartamentos" class="collapse" aria-labelledby="headingDepartamentos" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="TablaDepartamentos.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>"><i class="fas fa-fw fa-table"></i> Mostrar Departamentos</a>
            <a class="collapse-item" href="CreacionDepartamentos.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-plus" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><line x1="12" y1="11" x2="12" y2="17" /><line x1="9" y1="14" x2="15" y2="14" /></svg> Crear Departamento Nuevo</a>
          </div>
      </li>
                      ...
                      <form class="formulario" action="SQLInsert_Departamentos.php" id="formulario" method="post">
                        ...
                        <div class="formulario__grupo" id="grupo__DescripcionDepto">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="DescripcionDepto" id="DescripcionDepto" title="Ingresa nombre del departamento" onkeypress="return soloLetras(event)" placeholder="Nombre del Departamento" value="<?php if (isset($row)) {echo $row['DescripcionDepto'];} ?>" required minlength="5" maxlength="30">
                          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="../Login/oginForm.php">Cerrar Sesion</a>
        </div>
      </div>
    </div>
  </div>
