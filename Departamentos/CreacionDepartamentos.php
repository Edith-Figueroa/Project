                      ...
                      <form class="formulario" action="SQLInsert_Departamentos.php" id="formulario" method="post">
                        ...
                        <div class="formulario__grupo" id="grupo__DescripcionDepto">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="DescripcionDepto" id="DescripcionDepto" title="Ingresa nombre del departamento" onkeypress="return soloLetras(event)" onblur="upperCase('DescripcionDepto')" placeholder="Nombre del Departamento" value="<?php if (isset($row)) {echo $row['DescripcionDepto'];} ?>" required minlength="5" maxlength="30">
                          </div>
