                      ...
                      <form class="formulario" action="Insert_Employee.php" id="formulario" method="post">
                        ...
                        <div class="formulario__grupo" id="grupo__identidad">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="Cedula" id="Cedula" onkeypress="return soloNumeros(event)" placeholder="Identidad" value="<?php if (isset($row)) {
                                                                                                                                                                            echo $row['Cedula'];
                        ...
                        <div class="formulario__grupo" id="grupo__primerNombre">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="PrimerNombre" id="PrimerNombre" onkeypress="return soloLetras(event)" placeholder="Primer Nombre" value="<?php if (isset($row)) {
                        ...
                        <div class="formulario__grupo" id="grupo__segundoNombre">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="SegundoNombre" id="SegundoNombre" onkeypress="return soloLetras(event)" placeholder="Segundo Nombre" value="<?php if (isset($row)) {
                        ...
                        <div class="formulario__grupo" id="grupo__primerApellido">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="PrimerApellido" id="PrimerApellido" onkeypress="return soloLetras(event)" placeholder="Primer Apellido" value="<?php if (isset($row)) {
                        ...
                        <div class="formulario__grupo" id="grupo__segundoApellido">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="SegundoApellido" id="SegundoApellido" onkeypress="return soloLetras(event)" placeholder="Segundo Apellido" value="<?php if (isset($row)) {
                        ...
                        <div class="formulario__grupo" id="grupo__telefono">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="Telefono" id="Telefono" onkeypress="return soloNumeros(event)" placeholder="Telefono" value="<?php if (isset($row)) {
                                                                                                                                                                              echo $row['Telefono'];
                        ...
                        <div class="formulario__grupo" id="grupo__Direccion">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class=" formulario__input" name="Direccion" id="Direccion" onkeypress="return soloLetrasYespeciales(event)" placeholder="Direccion" value="<?php if (isset($row)) {
                                                                                                                                                                                            echo $row['Direccion'];
                        ...
                        <div class="formulario__grupo" id="grupo__FechaNacimiento">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="date" name="FechaNacimiento" id="FechaNacimiento" class="formulario__input" placeholder="" value="<?php if (isset($row)) {
                        ...
                        <div class="formulario__grupo" id="grupo__fechaIngreso">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="date" name="FechaIngreso" class="formulario__input" placeholder="" value="<?php if (isset($row)) {
