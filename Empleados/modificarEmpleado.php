    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePlanillas" class="collapse" aria-labelledby="headingPlanillas" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="../Planilla/historialPlanillas.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>">Registro</a>
                    ...
                    <div class="p-5">
                      ...
                      <form class="formulario" id="formulario" action="Update_Employee.php" method="post">
                        ...
                        <div class="formulario__grupo" id="grupo__primerNombre">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="PrimerNombre" id="PrimerNombre" placeholder="Primer Nombre" value="<?php if (isset($row)) {echo $row['PrimerNombre'];} ?>" required maxlength="15">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__segundoNombre">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="SegundoNombre" id="SegundoNombre" onkeypress="return soloLetras(event)" placeholder="Segundo Nombre" value="<?php if (isset($row)) {echo $row['SegundoNombre'];} ?>" maxlength="15">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__primerApellido">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="PrimerApellido" id="PrimerApellido" onkeypress="return soloLetras(event)" placeholder="Primer Apellido" value="<?php if (isset($row)) {echo $row['PrimerApellido'];} ?>" required maxlength="15">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__segundoApellido">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="SegundoApellido" id="SegundoApellido" onkeypress="return soloLetras(event)" placeholder="Segundo Apellido" value="<?php if (isset($row)) {echo $row['SegundoApellido'];} ?>" maxlength="15">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__telefono">
                          ...
                          <p class="formulario__input-error">El telefono solo puede contener numeros,  debe iniciar con 2, 8 o 9 y el maximo son 8.</p>
                        </div>
                        <!--Grupo: Direccion-->
                        <div class="formulario__grupo" id="grupo__direccion">
                          <label for="direccion" class="formulario__label">Direccion</label>
                          <div class="formulario__grupo-input">
                            <input type="text" class=" formulario__input" name="Direccion" id="Direccion" onkeypress="return soloLetrasYespeciales(event)" placeholder="Direccion" value="<?php if (isset($row)) {echo $row['Direccion'];} ?>" required required maxlength="50">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__Ciudades_idCiudades">
                          ...
                          <select class="formulario__input" name="Ciudades_idCiudades" id="Ciudades_idCiudades" SelectedItem="null" value="<?php if (isset($row)) {echo $row['Ciudades_idCiudades'];} ?>" required>
                        ...
                        <div class="formulario__grupo" id="grupo__fechaNacimiento">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="date" name="FechaNacimiento" class="formulario__input" placeholder="" value="<?php if (isset($row)) {echo $row['FechaNacimiento'];} else {echo '2000-01-01';} ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="formulario__grupo" id="grupo__fechaIngreso">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="date" name="FechaIngreso" class="formulario__input" placeholder="" value="<?php if (isset($row)) {echo $row['FechaIngreso'];} else {echo '2000-01-01';} ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="formulario__grupo" id="grupo__cuentaBan">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="CuentaBancaria" id="CuentaBancaria" onkeypress="return soloNumeros(event)" placeholder="Cuenta Bancaria" value="<?php if (isset($row)) {echo $row['CuentaBancaria'];} ?>" required maxlength="13">
                          </div>
                          <p class="formulario__input-error">La cuenta bancaria solo puede contener numeros y el maximo son 13.</p>
                        </div>
                        <div class="formulario__grupo" id="grupo__cuentaBan">
                          <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" value="Modificar" required>
                        </div>
                        <div class="formulario__grupo" id="grupo__cuentaBan">
