    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <div class="form-group">
                <input type="" name="DescripcionCargo" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="" value="<?php if (isset($row)) {
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <div class="form-group">
                <input type="" name="Salario" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="" value="<?php if (isset($row)) {
                                                                                                                                            echo $row['Salario'];
                                                                                                                                        } ?>" required>
            </div>
        </div>
