    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseCargos" class="collapse" aria-labelledby="headingCargos" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="TablaCargos.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>">Mostrar Cargos</a>
            <a class="collapse-item" href="CreacionCargos.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>">Crear Cargo Nuevo</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-1 text-gray-800">Creacion de Cargo</h1>
        </div>
        <div class="container">
                      ...
                      <form class="formulario" action="SQLInsert_Cargos.php" id="formulario" method="post">
                        ...
                        <div class="formulario__grupo" id="grupo__DescripcionCargo">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="DescripcionCargo" id="DescripcionCargo" onkeypress="return soloLetras(event)" placeholder="Nombre de Cargo" value="<?php if (isset($row)) {echo $row['DescripcionCargo'];} ?>" required maxlength="30">
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__Salario">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="Salario" id="Salario" onkeypress="return soloNumeros(event)" placeholder="Salario" value="<?php if (isset($row)) {echo $row['Salario'];} ?>" required>
                          </div>
                        ...
                        <div class="formulario__grupo" id="grupo__Departamentos_idDepartamentos">
                          ...
                          <select class="formulario__input" name="Departamentos_idDepartamentos" id="Departamentos_idDepartamentos" value="" required>
