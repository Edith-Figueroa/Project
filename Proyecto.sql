...
INSERT INTO `ciudades` VALUES (7,'CHOLOMA'),(2,'CHOLUTECA'),(4,'COMAYAGUA'),(9,'DANLI'),(6,'EL PROGRESO'),(5,'LA CEIBA'),(13,'LA PAZ'),(12,'OLANCHITO'),(3,'SAN PEDRO SULA'),(10,'SANTA ROSA DE COPAN'),(11,'SIGUATEPEQUE'),(1,'TEGUCIGALPA'),(8,'TELA');
...
INSERT INTO `departamentos` VALUES (1,'VENTAS'),(2,'BODEGA'),(3,'ATENCION AL CLIENTE'),(4,'FINANCIERO'),(5,'COMPRAS'),(6,'RECURSOS HUMANOS'),(7,'ADMINISTRATIVO'),(8,'IT'),(9,'PRODUCCION');
...
INSERT INTO `cargos` VALUES (1,'VENDEDOR',8000,1),(2,'JEFE DE BODEGA',5000,2),(3,'RECEPCIONISTA',8000,3),(4,'ASESOR FINANCIERO',10000,4),(5,'EXPEDITOR',8000,5),(6,'DIRECTOR DE RECURSOS HUMANOS',21000,6),(7,'GERENTE GENERAL',65000,7),(8,'AUDITOR DE SISTEMAS',15000,8),(9,'DIRECTOR DE PLANTA',28000,9),(10,'SUPERVISOR DE VENTAS',20000,1),(11,'CARGUERO',8000,2),(12,'SUPERVISOR DE ATENCION AL CLIENTE',18000,3),(13,'ASESOR FISCAL',15000,4),(14,'DESARROLLADOR DE PROVEEDORES',24000,5),(15,'TECNICO DE SELECCION DE PERSONAL',23000,6),(16,'SUBGERENTE ADMINISTRATIVO',45000,7),(17,'ADMINISTRADOR DE BASE DE DATOS',20000,8),(18,'SUPERVISOR DE PLANTA',22000,9),(19,'GERENTE DE VENTAS',36000,1),(20,'DESPACHADOR',10000,2),(21,'TELEVENDEDOR',18000,3),(22,'ANALISTA',15000,4),(23,'LIDER DE COMPRAS',20000,5),(24,'RECLUTADOR',15000,6),(25,'ANALISTA DE CALIDAD',12000,7),(26,'DESARROLLADOR',15000,8),(27,'OPERARIOS',22000,9);
