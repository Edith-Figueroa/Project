    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <di id="collapseCiudades" class="collapse" aria-labelledby="headingCiudades" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="TablaCiudades.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>">Mostrar Ciudades</a>
            <a class="collapse-item" href="CreacionCiudades.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>">Crear Ciudad Nueva</a>
          </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-1 text-gray-800">Modificacion de Ciudad</h1>
        </div>
        <div class="container">
            ...
            <div class="col-xl-20 col-lg-12 col-md-9">
              ...
              <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                  ...
                  $upd = new database();
                  $upd->select("ciudades", "*", "idCiudades='$id'");
                  $result = $upd->sql;
                  ...
                  <div class="">
                    <div class="p-5">
                      <!--Inicio de Form-->
                      <form class="formulario" id="formulario" action="SQLUpdate_Ciudades.php" method="post">
                        <input type="hidden" name="idCiudades" value="<?php echo $Usuario; ?>">
                        ...
                        <div class="formulario__grupo" id="grupo__DescripcionCiudad">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="DescripcionCiudad" id="DescripcionCiudad" onkeypress="soloLetras(event)" placeholder="Nombre de la Ciudad" value="<?php if (isset($row)) {echo $row['DescripcionCiudad'];} ?>" required maxlength="15">
                          </div>
                          <p class="formulario__input-error">La descripcion de la ciudad solo acepta letras y su maximo son 15.</p>
                        </div>
                        <!--Grupo: Estado-->
